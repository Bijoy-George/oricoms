...
//error_reporting(E_ALL ^ E_NOTICE);	
	...
	define('CONFIG_UPLOAD_MAXSIZE', 500 * 1024 & 1024 ); //by bytes
	...
	define('CONFIG_UPLOAD_VALID_EXTS', 'gif,jpg,png,txt,mp4,jpeg'); // 
	...
	define("CONFIG_VIEWABLE_VALID_EXTS", 'gif,bmp,txt,jpg,png,tif,html,htm,js,css,xml,xsl,dtd,mp3,wav,wmv,wma,rm,rmvb,mov,swf,mp4,jpeg');
	...
	define('CONFIG_DEFAULT_VIEW', (CONFIG_SYS_THUMBNAIL_VIEW_ENABLE?'thumnail':'detail')); //thumnail or detail
