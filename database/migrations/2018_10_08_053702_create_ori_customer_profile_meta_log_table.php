...
class CreateOriCustomerProfileMetaLogTable extends Migration {
	...
	public function up()
	{
		Schema::create('ori_customer_profile_meta_log', function(Blueprint $table)
		{
			$table->bigInteger('id', true);
			$table->bigInteger('profile_meta_id')->nullable()->comment('Refered from ori_customer_profile_meta');
		...
		Schema::table('ori_customer_profile_meta_log', function (Blueprint $table) {
		...
		Schema::table('ori_customer_profile_meta_log', function (Blueprint $table) {
			$table->foreign('profile_meta_id')->references('id')->on('ori_customer_profile_meta')->onDelete('cascade');
		});
	}
	...
	{
		Schema::drop('ori_customer_profile_meta_log');
	}
