...
class AddColumnsToOriUsers extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('ori_users', function (Blueprint $table) {
            ...
            $table->integer('department')->nullable()->comment('Reffered from ori_mast_query_types')->after('panchayath_id');
            $table->integer('designation')->nullable()->comment('Reffered from ori_mast_designation')->after('department');
		});
	}
