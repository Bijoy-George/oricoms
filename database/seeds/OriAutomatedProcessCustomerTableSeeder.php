...
class OriAutomatedProcessCustomerTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \DB::table('ori_automated_process_customer')->delete();
        
        \DB::table('ori_automated_process_customer')->insert(array (
            0 => 
            array (
                'id' => 1,
                'cmpny_id' => 2,
            ...
            array (
                ...
                'updated_by' => 2,
                'created_at' => NULL,
                'updated_at' => '2018-11-15 11:39:37',
                'deleted_at' => NULL,
            ),
        ));
