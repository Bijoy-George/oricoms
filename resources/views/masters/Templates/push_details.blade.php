...
<div class="row m-0">
  <div class="col-md-12" >
    <div id="msg_push" style="display:none;padding: 20px 2px!important;"><span></span></div>
  </div>
  <div class="col-md-12 form-group">
    <input class="form-control" placeholder="Subject" type="text" value="@if(!empty($template_details->subject)){{ $template_details->subject }} @endif" name="new_subject" id="new_subject_push">
    <span id="new_sub_err"></span>
    </div>
  <div class="col-md-12 form-group">
  ...
  <div class="col-md-12 form-group">
    ...
    <input type="text" id="cmp_title_push" name="" class="form-control" placeholder="Please enter the title">
    <span id="cmp_title_err"></span>
    </div>
  <div class="col-md-12 form-group">
    <textarea id="new_content_push" name="new_content" class="req_description form-control" placeholder="Request">@if(!empty($template_details->content)){{ $template_details->content }} @endif</textarea>
