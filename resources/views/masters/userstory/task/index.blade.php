...
@endsection
@section('content')
<form action="{{url('/search_task')}}" method="POST" class="listing form-common" name="form-common">
  ...
  <div class="search-box">
    ...
    <div class="content-area">
      <header class="row align-items-center">
        <div class="col-sm-5">
          <h2 class="m-0">{{__('Task List')}} <span>({{$task_count}})</span></h2>
          <small>Task List</small> </div>
		...
		<div class="col-sm-7 text-right"><a href="{{url('userstoryList')}}/{{$project_id}}/{{$sprint_id}}" class="btn btn-danger"><img src="{{ asset('img/ic_arrow_back.svg') }}" alt=""></a>
      </header>
