        ...
        <div class="row justify-content-center text-center">
          ...
          <div class="col-sm-12" id="qstn"> @php 
            ...
            <div class="form-group">
              <h4 class="mb-2"><?php echo $i.'. '.$value['survey_eng_qstn']['questions'];?></h4>
              ...
              <input  type="radio" name="questions[<?php echo $value['id'];?>]"  value="option1" class="custom-radio" id="radio-1-{{$value['survey_eng_qstn']['id']}}" >
              <label for="radio-1-{{$value['survey_eng_qstn']['id']}}" class="custom-checkbox-label">{{$value['survey_eng_qstn']['option1']}}</label>
              <?php } ?>
              <?php if(isset($value['survey_eng_qstn']['option2']) && !empty($value['survey_eng_qstn']['option2'])){?>
              <input  type="radio" name="questions[<?php echo $value['id'];?>]"  value="option2" class="custom-radio" id="radio-2-{{$value['survey_eng_qstn']['id']}}">
              <label for="radio-2-{{$value['survey_eng_qstn']['id']}}" class="custom-checkbox-label">{{$value['survey_eng_qstn']['option2']}}</label>
              <?php } ?>
              <?php if(isset($value['survey_eng_qstn']['option3']) && !empty($value['survey_eng_qstn']['option3'])){?>
              <input  type="radio" name="questions[<?php echo $value['id'];?>]"  value="option3" class="custom-radio" id="radio-3-{{$value['survey_eng_qstn']['id']}}">
              <label for="radio-3-{{$value['survey_eng_qstn']['id']}}" class="custom-checkbox-label">{{$value['survey_eng_qstn']['option3']}}</label>
              <?php } ?>
              <?php if(isset($value['survey_eng_qstn']['option4']) && !empty($value['survey_eng_qstn']['option4'])){?>
              <input  type="radio" name="questions[<?php echo $value['id'];?>]"  value="option4" class="custom-radio" id="radio-4-{{$value['survey_eng_qstn']['id']}}">
              <label for="radio-4-{{$value['survey_eng_qstn']['id']}}" class="custom-checkbox-label">{{$value['survey_eng_qstn']['option4']}}</label>
              <?php } ?>
              <?php if(isset($value['survey_eng_qstn']['option5']) && !empty($value['survey_eng_qstn']['option5'])){?>
              <input  type="radio" name="questions[<?php echo $value['id'];?>]"  value="option5" class="custom-radio" id="radio-5-{{$value['survey_eng_qstn']['id']}}" >
              <label for="radio-5-{{$value['survey_eng_qstn']['id']}}" class="custom-checkbox-label">{{$value['survey_eng_qstn']['option5']}}</label>
              <?php } ?>
              <?php if(isset($value['survey_eng_qstn']['option6']) && !empty($value['survey_eng_qstn']['option6'])){?>
              <input  type="radio" name="questions[<?php echo $value['id'];?>]"  value="option6" class="custom-radio" id="radio-6-{{$value['survey_eng_qstn']['id']}}">
              <label for="radio-6-{{$value['survey_eng_qstn']['id']}}" class="custom-checkbox-label">{{$value['survey_eng_qstn']['option6']}}</label>
              <?php } ?>
            </div>
            @php $i++; @endphp
            @endif
