{!! Form::open(array('route' => 'search_pushcategory', 'class' => 'listing2 form-common', 'method'=>'POST', 'name' => 'form-common')) !!}
<aside class="sidebar">
  <div class="search-box">
      <div class="row align-items-center justify-content-center">
        ...
        <div class="col-sm-5 mb-2 mb-sm-0">
        	{{ Form::text('search_keywords', null, array('id' => 'push_search','class' => 'form-control','placeholder' => 'Keyword')) }}
        </div>
...
<div class="row">
  <div class="col-md-4 px-0" id="list4"></div>
  <div class="col-md-8 email-content py-4" id="push-content1"></div>
</div>
{!! Form::close() !!}