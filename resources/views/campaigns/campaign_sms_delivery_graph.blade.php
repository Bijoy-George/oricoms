...
<div class="widget report-widget">
        ...
        <div class="widget-content p-3"><a href="javascript:void(0)" onclick="exportSmsBatchReport({{$batch_id}},'xlsx')" id="xlsx" class="btn btn-primary">Download Excel xlsx</a> <a href="javascript:void(0)" onclick="exportSmsBatchReport({{$batch_id}},'csv')" id="csv" class="btn btn-primary">Download CSV</a></div>
</div>
