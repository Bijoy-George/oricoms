...
@section('tab-content')
	<div class="col-md-12 widget">
		<div class="row col-md-6" style="">
			<div class="" style="float:left;"><a href="{{ url('/groups') }}">{{ __('Groups') }} > </a></div>
			<div class="" style="float:left;"><a href="{{ url('/groups/'.$group->id.'/edit') }}"> {{ __('Edit Group') }} > </a></div>
			<div class="" style="float:left;"> {{ __('Group Excel Import') }} </div>
		</div>
		...
		<div class="col-sm-10">
    		...
    		{!! Form::open(array('url' => '/groups/' . $group->id . '/map_excel_fields', 'method'=>'POST', 'name' => 'form-upload', 'files' => true)) !!}
    			<div class="row">
